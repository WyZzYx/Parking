...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 dark:bg-gray-900 dark:border-gray-800 lg:relative lg:bg-transparent lg:dark:bg-transparent lg:border-t lg:mt-auto">
      <div className="flex justify-around max-w-4xl mx-auto lg:justify-center lg:gap-8">
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center w-full h-16 text-sm font-medium transition-colors lg:flex-row lg:w-auto lg:h-auto lg:gap-2 lg:px-4 lg:py-2 lg:rounded-md hover:bg-gray-100 dark:hover:bg-gray-800",
                isActive
